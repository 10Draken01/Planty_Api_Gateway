/**
 * Aplicación Principal del Microservicio Plants
 * Puerto: 3005
 */
...
class PlantsApp {
  ...
  private setupRoutes(): void {
    ...
    // Rutas de plants
    this.app.use('/plants', this.container.getPlantRoutes());
  ...
  start(): void {
    this.app.listen(config.port, () => {
      console.log('\n╔════════════════════════════════════════════════════════╗');
      console.log('║      PLANTS API - Gestión de Plantas               ║');
      console.log('╚════════════════════════════════════════════════════════╝');
      ...
      console.log(`   GET    http://localhost:${config.port}/plants/health`);
      console.log(`   GET    http://localhost:${config.port}/plants`);
